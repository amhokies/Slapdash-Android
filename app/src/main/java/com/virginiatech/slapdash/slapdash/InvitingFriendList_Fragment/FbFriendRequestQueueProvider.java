...
public class FbFriendRequestQueueProvider {
    private static FbFriendRequestQueueProvider mInstance;
        ...
        mImageLoader = new ImageLoader(mRequestQueue,
                new ImageLoader.ImageCache() {
                    private final LruCache<String, Bitmap>
                            cache = new LruBitmapCache(LruBitmapCache.getCacheSize(context));
